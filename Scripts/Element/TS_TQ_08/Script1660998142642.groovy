...
WebUI.setText(findTestObject('Object Repository/Page_ToolsQA/input_Email_userEmail'), '123sanidra123')
...
WebUI.setText(findTestObject('Object Repository/Page_ToolsQA/textarea_Permanent Address_permanentAddress'), 'JL mandarin no.05 Jakarta Pusat')
