...
WebUI.click(findTestObject('Object Repository/Page_ToolsQA/span_Radio Button'))

WebUI.click(findTestObject('Object Repository/Page_ToolsQA/label_Yes'))

WebUI.click(findTestObject('Object Repository/Page_ToolsQA/label_Impressive'))

WebUI.click(findTestObject('Object Repository/Page_ToolsQA/label_No'))

WebUI.click(findTestObject('Object Repository/Page_ToolsQA/span_Impressive'))
