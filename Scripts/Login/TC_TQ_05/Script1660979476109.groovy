...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_ToolsQA/input_Password_password'), 'J8UQjcViU5Ew7HNuQTsOLQ==')

WebUI.click(findTestObject('Object Repository/Page_ToolsQA/button_Login'))

WebUI.click(findTestObject('Object Repository/Page_ToolsQA/p_Invalid username or password'))
...
WebUI.click(findTestObject('Object Repository/Page_ToolsQA/label_budisanidra'))
